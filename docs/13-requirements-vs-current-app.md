...
- Google スプレッドシートに  
  **企業名 / URL / 要約 / 仮説 / 決裁者名（任意）/ 手紙下書き** を整形して出力。
...
- **リスト作成・PDF/Google 情報・決裁者名・スプレッドシート/Docs 出力・Python 化**は、いずれも HypoFrame の現状では未対応であり、要件を満たすには別モジュールまたは別システムの追加が必要。
...
| 決裁者名 | 構造化テキストや「代表者」「役員」周辺を正規表現/LLM で抽出し、要約または専用フィールドで出力。 |
