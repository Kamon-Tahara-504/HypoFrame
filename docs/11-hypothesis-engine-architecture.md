...
- **優先キーワードの一覧・スコア**: 設計書に記載のうえ、実装で定数化する
- **深度2**: 「トップから2クリック以内」と解釈
- **Structurizer 出力形式**: 案A（カテゴリ別オブジェクト）または案B（見出し付き1本）。案B を採用した場合、Hypothesis Engine は現状の「1本の text」入力のまま受け取れる
